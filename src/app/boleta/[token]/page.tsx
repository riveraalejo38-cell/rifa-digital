...
export default function BoletaPage() {
  ...
  const fotos = [
    { src: "/camioneta.png", alt: "Nissan Frontier" },
    ...
    <div style={{
      ...
      <div style={{ maxWidth: "440px", width: "100%" }}>
        ...
        <div style={{
          ...
          <p style={{ margin: "0 0 8px", fontSize: "11px", letterSpacing: "3px", color: "#6B7280", fontWeight: "600" }}>
            TU NÚMERO
          </p>
          <div style={{
...
borderRadius: "20px",
padding: "20px 48px",
boxShadow: "0 8px 32px rgba(59,89,152,0.3)",
          }}>
            <p style={{
             color: "#FFFFFF",
              fontSize: "72px",
        ...
        {ticket.client && (
          <div style={{ background: "#FFFFFF", padding: "20px 24px", borderBottom: "1px solid #E5E7EB" }}>
            <p style={{ margin: "0 0 14px", fontSize: "11px", letterSpacing: "2px", color: "#6B7280", fontWeight: "600" }}>
            ...
            <div style={{
              ...
              <div style={{ textAlign: "right" }}>
                ...
                <p style={{ margin: "2px 0 0", fontSize: "20px", fontWeight: "800", color: saldoPendiente === 0 ? "#2D6A4F" : "#D97706" }}>
        ...
        <div style={{ background: "#FFFFFF", padding: "20px 24px", borderBottom: "1px solid #E5E7EB" }}>
          ...
          <div style={{
            ...
            <img
              ...
              onError={(e) => {
                (e.target as HTMLImageElement).src = "https://placehold.co/440x200/F2F4F7/6B7280?text=" + fotos[fotoActiva].alt;
              }}
            />
            <div style={{
              position: "absolute", bottom: "10px", left: "50%", transform: "translateX(-50%)",
              background: "rgba(28,28,46,0.7)", borderRadius: "999px", padding: "4px 12px",
            }}>
          ...
          <div style={{ display: "flex", gap: "8px", justifyContent: "center" }}>
            {fotos.map((f, i) => (
              <button key={i} onClick={() => setFotoActiva(i)} style={{
                width: "60px", height: "44px",
                borderRadius: "8px",
                overflow: "hidden",
                border: i === fotoActiva ? "2px solid #3B5998" : "2px solid transparent",
                padding: 0,
                cursor: "pointer",
                background: "#F2F4F7",
              }}>
                <img
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = "https://placehold.co/60x44/F2F4F7/6B7280?text=" + (i + 1);
                  }}
                />
              </button>
            ))}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            {[
              ...
              <div key={p.titulo} style={{
                ...
                paddingBottom: "12px", borderBottom: "1px solid #F2F4F7",
              }}>
                <div>
                ...
                <span style={{
                  background: "#DBEAFE", color: "#3B5998",
        ...
        <div style={{ background: "#FFFFFF", padding: "20px 24px", borderBottom: "1px solid #E5E7EB" }}>
          ...
          <p style={{ margin: "0 0 8px", fontSize: "13px", color: "#4B5563", lineHeight: "1.6" }}>
            • La boleta debe estar <strong>100% pagada</strong> ({formatPeso(TICKET_PRICE)}) para participar en el sorteo principal.
          </p>
          <p style={{ margin: "0 0 8px", fontSize: "13px", color: "#4B5563", lineHeight: "1.6" }}>
            • El sorteo se basa en las <strong>últimas 4 cifras</strong> de la Lotería de Boyacá o Manizales.
          </p>
          <p style={{ margin: 0, fontSize: "13px", color: "#4B5563", lineHeight: "1.6" }}>
            • Fecha del sorteo: <strong>{fechaSorteo}</strong>
          </p>
        </div>
        ...
        <div style={{
          ...
          <p style={{ margin: "0 0 16px", fontSize: "11px", color: "#6B7280" }}>
            Documento oficial de participación · Aplican términos y condiciones
          </p>
          <button onClick={guardarBoleta} style={{
            width: "100%",
            background: "#3B5998",
            border: "none",
            borderRadius: "12px",
