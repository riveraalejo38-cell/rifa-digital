  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0F1B2A", fontFamily: "'DM Sans', 'Segoe UI', sans-serif" }}>
      ...
      <div style={{ maxWidth: "460px", margin: "0 auto", padding: "0 20px 48px" }}>
        ...
        {/* Contador regresivo */}
        <div style={{ background: "#1E3348", borderRadius: "20px", padding: "20px", marginBottom: "18px", border: "1.5px solid #28405A" }}>
        ...
        {!reservaExito && (
          <div style={{ background: "#1E3348", borderRadius: "20px", padding: "24px", border: "1.5px solid #28405A", marginBottom: "16px" }}>
